...
getwp()
{
	...
	wp core install --path="$DATA_DIR/wordpress" --url=rsiah.42.fr --title=Inception --admin_user="$WP_ADMIN" --admin_password="$WP_ADMIN_PASS" --admin_email=rsiah@student.42singapore.sg
